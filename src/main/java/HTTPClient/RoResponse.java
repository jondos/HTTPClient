/*
 * @(#)RoResponse.java					0.3 30/01/1998
 *
 ...
 * might read the response info but musn't modify the response.
 *
...
public interface RoResponse
{
    ...
    /**
     * @return true if the request should be retried by the application.
     */
