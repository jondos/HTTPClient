...
public class HTTPResponse implements GlobalConstants, HTTPClientModuleConstants
{
    ...
    /**
     * Get the original URL used in the request.
     *
     * @return the URL used in primary request
     */
    public final URL getOriginalURL()
    {
	try
	    { return OriginalURI.toURL(); }
    ...
    /**
     * Get the final URL of the document. If the request was redirected
     * via the "moved" (301, 302, 303, or 307) return status this returns
     * the URL used in the last redirection; otherwise it returns the
     * original URL.
     *
