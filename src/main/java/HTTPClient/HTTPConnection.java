...
public class HTTPConnection implements GlobalConstants, HTTPClientModuleConstants
{
	...
	static
	{
		...
		{
			Default_Tunnel_Host =
				System.getProperty("HTTPClient.tunnelHost");
			if (Default_Tunnel_Host != null)
			{
				Default_Tunnel_Host = Default_Tunnel_Host.trim().toLowerCase();
			}
			Default_Tunnel_Port =
				Integer.getInteger("HTTPClient.tunnelPort").intValue();

			if (DebugConn)
			{
				if (Default_Tunnel_Host != null)
				{
					Util.logLine("Conn:  using tunnel " + Default_Tunnel_Host +
								 ":" + Default_Tunnel_Port);
				}
			}
		}
...
/**
	 ...
	 * @exception ModuleException if an exception is encountered in any module.
	 */
	public HTTPResponse Head(String file, NVPair form_data[]) throws IOException,
		ModuleException
	{
...
/**
	 ...
	 * @exception ModuleException if an exception is encountered in any module.
	 */
	public HTTPResponse Head(String file, String query) throws IOException,
		ModuleException
	{
...
/**
	 ...
	 * @exception ModuleException if an exception is encountered in any module.
	 */
	public HTTPResponse Get(String file, NVPair form_data[]) throws IOException,
		ModuleException
	{
...
/**
	 ...
	 * @exception ModuleException if an exception is encountered in any module.
	 */
	public HTTPResponse Get(String file, String query) throws IOException,
		ModuleException
	{
...
/**
	 ...
	 * @exception ModuleException if an exception is encountered in any module.
	 */
	public HTTPResponse Post(String file, NVPair form_data[]) throws IOException,
		ModuleException
	{
		NVPair[] headers =
			{
...
/**
	 ...
	 * @exception ModuleException if an exception is encountered in any module.
	 */
	public HTTPResponse Post(String file, NVPair form_data[], NVPair headers[]) throws
		IOException, ModuleException
	{
		if (Util.getIndex(headers, "Content-Type") == -1)
		{
			headers = Util.addValue(headers, "Content-type",
...
/**
	 ...
	 * @exception ModuleException if an exception is encountered in any module.
	 */
	public HTTPResponse Post(String file, String data) throws IOException,
		ModuleException
	{
...
/**
	 ...
	 * @exception ModuleException if an exception is encountered in any module.
	 */
	public HTTPResponse Post(String file, String data, NVPair[] headers) throws
		IOException, ModuleException
	{
		byte tmp[] = null;
...
/**
	 ...
	 * @exception ModuleException if an exception is encountered in any module.
	 */
	public HTTPResponse Post(String file, byte data[]) throws IOException,
		ModuleException
	{
		return Post(file, data, null);
	}
...
/**
	 ...
	 * @exception ModuleException if an exception is encountered in any module.
	 */
	public HTTPResponse Post(String file, byte data[], NVPair[] headers) throws
		IOException, ModuleException
	{
		if (data == null)
		{
...
/**
	 ...
	 * @exception ModuleException if an exception is encountered in any module.
	 */
	public HTTPResponse Post(String file, HttpOutputStream stream) throws
		IOException, ModuleException
	{
...
/**
	...
	public HTTPResponse Post(String file, HttpOutputStream stream,
							 NVPair[] headers) throws IOException,
		ModuleException
	{
...
/**
	 ...
	 * @exception ModuleException if an exception is encountered in any module.
	 */
	public HTTPResponse Put(String file, String data) throws IOException,
		ModuleException
	{
...
/**
	 ...
	 * @exception ModuleException if an exception is encountered in any module.
	 */
	public HTTPResponse Put(String file, String data, NVPair[] headers) throws
		IOException, ModuleException
	{
		byte tmp[] = null;
...
/**
	 ...
	 * @exception ModuleException if an exception is encountered in any module.
	 */
	public HTTPResponse Put(String file, byte data[]) throws IOException,
		ModuleException
	{
		return Put(file, data, null);
	}
...
/**
	 ...
	 * @exception ModuleException if an exception is encountered in any module.
	 */
	public HTTPResponse Put(String file, byte data[], NVPair[] headers) throws
		IOException, ModuleException
	{
		if (data == null)
		{
...
/**
	 ...
	 * @exception ModuleException if an exception is encountered in any module.
	 */
	public HTTPResponse Put(String file, HttpOutputStream stream) throws
		IOException, ModuleException
	{
...
/**
	 ...
	 * @exception ModuleException if an exception is encountered in any module.
	 */
	public HTTPResponse Options(String file, NVPair[] headers) throws IOException,
		ModuleException
	{
...
/**
	 ...
	 * @exception ModuleException if an exception is encountered in any module.
	 */
	public HTTPResponse Options(String file, NVPair[] headers, byte[] data) throws
		IOException, ModuleException
	{
...
/**
	...
	public HTTPResponse Options(String file, NVPair[] headers,
								HttpOutputStream stream) throws IOException,
		ModuleException
	{
...
/**
	 ...
	 * @exception ModuleException if an exception is encountered in any module.
	 */
	public HTTPResponse Delete(String file, NVPair[] headers) throws IOException,
		ModuleException
	{
...
/**
	 ...
	 * @exception ModuleException if an exception is encountered in any module.
	 */
	public HTTPResponse Trace(String file, NVPair[] headers) throws IOException,
		ModuleException
	{
...
/**
	 * Connects to the host/port specified in the constructor. If necessary, proxies (HTTP or
	 * SOCKS) will be tunneled by this call. If no proxy has to be used, this method connects
	 * directly to the specified server. A call of this method is independent from all other
	 * method calls of this object. Everytime this method is called, a new Socket is created.
	 *
	 * @return The Socket which is connected to the specified server/host (tunneled through
	 ...
	 * @author  added by Stefan Lieske, 2005/02/14
         * @throws ThreadInterruptedIOException if the current thread was interrupted
	 */
	public Socket Connect() throws IOException, ModuleException, ThreadInterruptedIOException
	{
		...
		if (resultSocket == null)
		{
			...
			throw (new IOException(
				"HTTPClient: Connect: Internal error - could not get the Socket."));
		}
		return resultSocket;
	}
...
/**
	...
	public HTTPResponse ExtensionMethod(String method, String file,
										byte[] data, NVPair[] headers) throws
		IOException, ModuleException
	{
...
/**
	 ...
	 */
	public HTTPResponse ExtensionMethod(String method, String file,
										HttpOutputStream os, NVPair[] headers) throws
		IOException, ModuleException
	{
...
/**
	 ...
	 * arrives on the socket for the specified time.
	 *
	 ...
	 * connection creation.
	 *
	 * <P><em>Note:</em> Because the decompression streams used by the
	 * ContentEncodingModule and TransferEncodingModule cannot be restarted
	 * after an InterruptedIOException you must either disable these
	 * modules or invoke <code>stop()</code> after receiving the exception.
	 *
	 * Using this method with JDK 1.0.2 or earlier will only influence the
	 * connection creation.
	 *
...
DefaultModuleList.size() + pos + 1);
		...
		if (DebugConn)
		{
			Util.logLine("Conn:  Added module " + module.getName() +
						 " to default list");
		}
...
/**
	...
	public static boolean removeDefaultModule(Class module)
	{
		...
		if (DebugConn)
		{
			if (removed)
			{
				Util.logLine("Conn:  Removed module " + module.getName() +
							 " from default list");
			}
		}
...
/**
	 ...
	 *            or the auth handler does not handle the Digest scheme
	 * @see AuthorizationInfo#addDigestAuthorization(java.lang.String, int, java.lang.String, java.lang.String, java.lang.String)
	 */
	public void addDigestAuthorization(String realm, String user, String passwd) throws
...
/**
	 ...
	 * @param passw the password
	 * @exception AuthSchemeNotImplException if no auth handler is installed
	 *            or the auth handler does not handle the Basic scheme
	 * @see AuthorizationInfo#addBasicAuthorization(java.lang.String, int, java.lang.String, java.lang.String, java.lang.String)
	 */
	public void addBasicAuthorization(String realm, String user, String passwd) throws
		AuthSchemeNotImplException
	{
...
/**
	 ...
	 */
	public static void setSocksServer(String host, int port, int version) throws
		SocksException
	{
		if (port <= 0)
		{
...
/**
	...
	void handleRequest(Request req, HTTPResponse http_resp, Response resp,
					   boolean usemodules) throws IOException, ModuleException
	{
		Response[] rsp_arr =
			{
			resp};
...
/**
	 ...
	 *                            tunneling handshake
	 */
	Response sendRequest(Request req, int con_timeout) throws IOException,
		ModuleException
	{
		...
		if (early_stall != null)
		{
			try
			{
				if (DebugConn)
				{
					Util.logLine("Conn:  Early-stalling Request: " +
		...
		synchronized (this)
		{
			...
			if (late_stall != null)
			{
				if (input_demux != null || KeepAliveUnknown)
				{
					if (DebugConn)
					{
						Util.logLine("Conn:  Stalling Request: " + req.getMethod() +
" " + req.getRequestURI());
					}
			 ...
			 */
			if (req.getMethod().equals("POST") && prev_resp != null &&
				input_demux != null)
			{
				if (DebugConn)
				{
			...
			if (DebugConn)
			{
				...
				{
					Util.logLine("Conn:  Number of requests left: " +
								 KeepAliveReqLeft);
				}
			}
     ...
     *  @throws ThreadInterruptedIOException if the current thread was interrupted (Rolf Wendolsky 06/06/17)
	 */
	private Socket getSocket(int con_timeout) throws IOException, ThreadInterruptedIOException
	{
		...
		if (DebugConn)
		{
			Util.logLine("Conn:  Creating Socket: " + actual_host + ":" +
						 actual_port);
		}
...
/**
	 ...
	 */
	private Response enableSSLTunneling(Socket[] sock, Request req, int timeout) throws
		IOException, ModuleException
	{
...
/**
	...
	private String[] assembleHeaders(Request req,
									 ExtByteArrayOutputStream hdr_buf) throws
		IOException
	{
		String[] con_hdrs =
			{
		...
		if (req.getData() != null || req.getStream() != null)
		{
			...
			if (req.getData() != null)
			{
				hdr_buf.write("Content-length: ",
							  Integer.toString(req.getData().length), "\r\n");
			}
			else if (req.getStream().getLength() != -1 && tc_idx == -1)
			{
				hdr_buf.write("Content-length: ",
							  Integer.toString(req.getStream().getLength()),
							  "\r\n");
			}
...
/**
	...
	boolean handleFirstRequest(Request req, Response resp) throws IOException
	{
		...
		if (DebugConn)
		{
			Util.logLine("Conn:  Protocol Version established: " +
		...
		try
		{
				...
				(con = resp.getHeader("Keep-Alive")) != null)
			{
				...
				if (max != null && max.getValue() != null)
				{
					...
					if (DebugConn)
					{
						Util.logLine("Conn:  Max Keep-Alive requests: " +
									 KeepAliveReqMax);
					}
				}
			}
